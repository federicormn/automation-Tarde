...
public class Control
{
    ...
    public void indicateURL()
    {
        Session.getInstance().getBrowser().getCurrentUrl();
        this.step("Go to: "+Session.getInstance().getBrowser().getCurrentUrl());
    }
    ...
    {
        this.findControl();
        this.step("Get the attribute" + control.getAttribute(attribute) + " from control "+ controlName);
